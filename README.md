...
- Resource page (canonical): https://matrixtrak.com/resources/idempotency-keys-contract-template-dotnet
- Primary blog posts:
  - https://matrixtrak.com/blog/idempotency-keys-for-apis-prevent-duplicate-orders-emails-writes
